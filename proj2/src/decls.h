...
public:
    ...
    /** True iff I represent an instance variable. */
    ...
    virtual Type_Ptr asType (int arity, const AST_Vect& params) const;
     ...
     *  my members. */
    virtual Decl* newVarDecl (AST_Ptr id, AST_Ptr type);
    ...
    virtual Decl* addVarDecl (AST_Ptr id, AST_Ptr type = newTypeVar ());

    /* ADDED */
    virtual Decl* addClassDecl (AST_Ptr id, AST_Ptr params);
    ...
    virtual Decl* addParamDecl (AST_Ptr id, int k, AST_Ptr type);
    ...
    virtual void addParam (Decl* param);

    virtual Decl_Vect* getParams();
...
private:
    ...
    Environ* _members;
    AST_Ptr _ast;
    Unifier* globalUnifier;
};

//extern std::vector<Decl*> allDecls;
